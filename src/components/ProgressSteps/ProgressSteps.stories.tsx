...
// Completed state (precisa ultrapassar o último step)
export const AllCompleted: Story = {
    args: {
        currentStep: 5, // 5 porque são 4 steps, precisa ultrapassar
        steps: defaultSteps,
    },
};

// Completed state com cores customizadas
export const AllCompletedWithCustomColors: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: defaultSteps,
        completedColors: {
            primary: '#9333ea',
            secondary: '#c084fc',
...
export const AllCompletedFilled: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: defaultSteps,
        variant: 'filled',
...
export const AllCompletedOutlined: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: defaultSteps,
        variant: 'outlined',
...
export const AllCompletedWithIcons: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: stepsWithIcons,
        showNumbers: false,
...
export const AllCompletedVertical: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: defaultSteps,
        orientation: 'vertical',
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    >
                        {currentStep === args.steps.length ? 'Finalizar' : 'Next'}
                    </button>
                </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', alignItems: 'center' }}>
                ...
                {currentStep > args.steps.length && (
                    <div style={{
                        ...
                        ✅ Processo completo! Todos os passos foram concluídos.
                    </div>
                )}
            </div>
        );
...
export const CheckoutFlowCompleted: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: [
            { id: 1, label: 'Cart', description: 'Review items' },
...
export const OnboardingFlowCompleted: Story = {
    args: {
        currentStep: 5, // Ultrapassou os 4 steps
        steps: [
            {
